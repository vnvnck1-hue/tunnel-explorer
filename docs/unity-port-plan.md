...
**M4 남은 것**: 미이식 서브시스템 8종(자동 드릴·소용돌이·행성 파쇄기·대붕괴·드릴 폭풍) — 각각 별도 시스템이라 M4 후속 커밋으로. 그 외는 사장님 확인 대기.
...
확인 포인트: 파면 팔수록 적이 몰리는 압력이 재미인지 압박인지, 보스 예고탄·벽 기믹의 읽힘, 카드 등급 분포, 휴식 화면의 정보량.
