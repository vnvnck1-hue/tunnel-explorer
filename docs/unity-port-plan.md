...
| 핑 9종·8방향 휠·컨텍스트·도배 방지·AI 명령 주입·AI 자발 핑 / 채팅·말풍선·AI 멘트 10문장 / 퀵크래프트 6레시피 | 진행 중 |
| 테스트 | CrewTests 9 (KIT 표 · 편성/층 유지 · 경로 · 표적 이력 · AI 탄/처치 XP · 굴착 크레딧 · 전원 탑승 · 리더 기절 구조 · 크루 다운 구조) |
