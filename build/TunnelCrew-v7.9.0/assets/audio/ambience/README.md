...
| `tunnel-dungeon.ogg` | 땅굴 (1층) | 94.3s | 1.19 | `dungeon_ambient_1.ogg` |
| `tunnel-cave-stereo.ogg` | 땅굴 (2층) | 57.0s | **4.48** | `553080__nox_sound__ambiance_atmosphere_cave_loop_stereo.ogg` |

땅굴은 두 파일을 **동시에** 재생한다. 길이가 94.3s / 57.0s 로 서로 달라서
합쳐진 주기가 길고, 재생 시작 위치도 매번 랜덤이라 반복감이 잘 안 느껴진다.

2026-09-02 땅굴 두 레이어를 일괄 +40% 했다 (0.85→1.19 · 3.20→4.48). `tunnel-cave-stereo` 의 게인이 큰 것은 원본 녹음 레벨이 매우 낮기 때문이다
