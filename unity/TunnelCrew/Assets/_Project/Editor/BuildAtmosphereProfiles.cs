    ...
    public static class BuildAtmosphereProfiles
    {
        ...
        static readonly Spec[] Specs =
        {
            ...
            new Spec
            {
                ...
                GrainStrength = 0.018f, GrainDensity = 540f,
            },
            ...
            new Spec
            {
                ...
                GrainStrength = 0.026f, GrainDensity = 560f,
            },
            ...
            new Spec
            {
                ...
                GrainStrength = 0.034f, GrainDensity = 580f,
            },
            // 이상지대 · abyss — 바닥 균열에서 빛이 온다(광원 방향 계약 §5-1). 색이 거의 빠지고
            // 그레인이 화면 정체성이 된다(Katana ZERO·SIGNALIS 대역).
            new Spec
            {
                Name = "Abyss",
                ...
                GrainStrength = 0.044f, GrainDensity = 600f,
            },
        };
        ...
        public static void Run()
        {
            ...
            Debug.Log($"[비주얼] 지층별 대기 프로파일 — 신규 {made} · 갱신 {updated} " +
                      $"(안개 0.22→0.46 · 깊이분리 0.12→0.28 · 비네트 0.35→0.58 · 그레인 0.018→0.044)");
        }
    }
}
