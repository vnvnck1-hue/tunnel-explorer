        ...
        void DrawCell(int c, int r)
        {
            ...
            _groundDecal.SetTile(pos,
                (s.Surfaces & SurfaceMask.ContactAo) != 0
                    ? TileFor(EnvironmentKit.Pick(_kit.contactAo, s.FloorModule))
                    : null);
            ...
            else if ((s.Surfaces & SurfaceMask.WestSide) != 0)
                front = TileFor(EnvironmentKit.Pick(_kit.westSide, s.FrontModule));
            else if ((s.Surfaces & SurfaceMask.EastSide) != 0)
                front = TileFor(EnvironmentKit.Pick(_kit.eastSide, s.FrontModule));
